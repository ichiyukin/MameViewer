...
ローカル専用の漫画・画像ビューアなのだ。「軽快さ」を最優先に設計しているのだ。

Mangameeyaからこのかた満足のゆくビューアがみあたらないのだ、自作したのだ。
ゆっくりと機能を充実させてゆくのだ。
...
本アプリは**寄付制（ドネーションウェア）**です。機能制限はないのだ、ふとっ腹なのだ。
気に入ったら、[GitHub Sponsors](https://github.com/sponsors/ichiyukin) から開発の支援をいただけると励みになるのだ。
